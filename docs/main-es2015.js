...
module.exports = __webpack_require__(/*! E:\NEW HRMS\Frontend\hrms_frontend_v2\src\main.ts */"zUnb");
...
UserGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_login_services_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], UserGuard);
...
/* harmony import */ var _guard_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./guard/auth.interceptor */ "wJCG");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            _guard_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__["authInterceptorProviders"],
...
let LoginService = class LoginService {
    ...
    getUserRole() {
        ...
        let hrCremp = this.getUser();
        console.log("ROLE" + hrCremp.authorities[0].authority);
        // return hrCremp.authorities[0].authority;
...
LoginService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])
], LoginService);
...
const routes = [
    { path: 'login', loadChildren: () => Promise.all(/*! import() | login-login-module */[__webpack_require__.e("default~all-modules-all-modules-module~login-login-module"), __webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "X3zk")).then(m => m.LoginModule) },
    ...
    { path: '', loadChildren: () => Promise.all(/*! import() | all-modules-all-modules-module */[__webpack_require__.e("default~all-modules-all-modules-module~login-login-module"), __webpack_require__.e("all-modules-all-modules-module")]).then(__webpack_require__.bind(null, /*! ./all-modules/all-modules.module */ "HYfV")).then(m => m.AllModulesModule), canActivate: [_guard_user_guard__WEBPACK_IMPORTED_MODULE_3__["UserGuard"]] },
    { path: '**', loadChildren: () => Promise.all(/*! import() | login-login-module */[__webpack_require__.e("default~all-modules-all-modules-module~login-login-module"), __webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "X3zk")).then(m => m.LoginModule) },
];
...
/* harmony import */ var _login_services_login_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../login/services/login.service */ "d//k");
...
let AuthInterceptor = class AuthInterceptor {
    constructor(login, router, toastr) {
        this.login = login;
        this.router = router;
        this.toastr = toastr;
    }
...
AuthInterceptor = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_login_services_login_service__WEBPACK_IMPORTED_MODULE_7__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])
], AuthInterceptor);
